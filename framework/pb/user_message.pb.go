...
var file_user_message_proto_rawDesc = []byte{
	...
	0x72, 0x6f, 0x74, 0x6f, 0x12, 0x12, 0x65, 0x69, 0x63, 0x72, 0x61, 0x77, 0x6c, 0x6c, 0x65, 0x72,
	0x2e, 0x65, 0x69, 0x70, 0x72, 0x69, 0x63, 0x65, 0x22, 0x53, 0x0a, 0x0b, 0x55, 0x73, 0x65, 0x72,
	...
	0x12, 0x1f, 0x2e, 0x65, 0x69, 0x63, 0x72, 0x61, 0x77, 0x6c, 0x6c, 0x65, 0x72, 0x2e, 0x65, 0x69,
	0x70, 0x72, 0x69, 0x63, 0x65, 0x2e, 0x55, 0x73, 0x65, 0x72, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73,
	0x74, 0x1a, 0x20, 0x2e, 0x65, 0x69, 0x63, 0x72, 0x61, 0x77, 0x6c, 0x6c, 0x65, 0x72, 0x2e, 0x65,
	0x69, 0x70, 0x72, 0x69, 0x63, 0x65, 0x2e, 0x55, 0x73, 0x65, 0x72, 0x52, 0x65, 0x73, 0x70, 0x6f,
...
var file_user_message_proto_goTypes = []interface{}{
	(*UserRequest)(nil),  // 0: eicrawller.eiprice.UserRequest
	(*UserResponse)(nil), // 1: eicrawller.eiprice.UserResponse
}
var file_user_message_proto_depIdxs = []int32{
	0, // 0: eicrawller.eiprice.UserService.CreateUser:input_type -> eicrawller.eiprice.UserRequest
	1, // 1: eicrawller.eiprice.UserService.CreateUser:output_type -> eicrawller.eiprice.UserResponse
...
func (c *userServiceClient) CreateUser(ctx context.Context, in *UserRequest, opts ...grpc.CallOption) (*UserResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/eicrawller.eiprice.UserService/CreateUser", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _UserService_CreateUser_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/eicrawller.eiprice.UserService/CreateUser",
	}
...
var _UserService_serviceDesc = grpc.ServiceDesc{
	ServiceName: "eicrawller.eiprice.UserService",
